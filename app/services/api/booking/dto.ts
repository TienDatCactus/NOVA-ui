...
export type CheckinBookingRequestDto = z.infer<
  typeof CheckinBookingRequestSchema
>;

export type PreAssignRoomsRequestDto = z.infer<
  typeof PreAssignRoomsRequestSchema
>;
