              ...
              <PopoverTrigger asChild>
                ...
                >
                  ...
                  {filterState.selectedStaffId && (
                    <Badge
                      variant="secondary"
                      className="ml-0.5 h-4 w-4 p-0 text-[10px] flex items-center justify-center"
                    >
                      1
                    </Badge>
                  )}
              ...
              <PopoverTrigger asChild>
                ...
                >
                  ...
                  {filterState.selectedShiftIds.length > 0 && (
                    <Badge
                      variant="secondary"
                      className="ml-0.5 h-4 min-w-4 px-1 text-[10px] flex items-center justify-center"
                    >
                      ...
                      {!workShifts || workShifts.length === 0 ? (
                        ...
                        workShifts.map((shift) => (
                          ...
                          >
                            <Checkbox
                              id={`shift-${shift.id}`}
                              checked={filterState.selectedShiftIds.includes(
                                shift.id
                              )}
                              onCheckedChange={() =>
                                handleShiftToggle(shift.id)
                              }
                              className="h-3.5 w-3.5"
                            />
                            <Label
