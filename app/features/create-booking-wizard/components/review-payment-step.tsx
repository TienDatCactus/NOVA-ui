...
export function BookingCartWidget({ form }: BookingCartWidgetProps) {
  ...
  const source = form.watch("source"); // Booking source for payment filtering
  ...
  return (
    <CurrencyView amount={finalTotal}>
                          ...
                          render={({ field }) => (
                            <FormItem>
                              <FormLabel className="text-xs font-medium flex items-center gap-1.5 text-foreground">
                                <MessageSquare className="h-3 w-3" /> Yêu cầu
                                của khách
                              </FormLabel>
                              <FormControl>
                                <Textarea
                          ...
                          render={({ field }) => (
                            <FormItem>
                              <FormLabel className="text-xs font-medium flex items-center gap-1.5 text-amber-600 dark:text-amber-500">
                                <ShieldAlert className="h-3 w-3" /> Ghi chú nội
                                bộ (Staff Only)
                              </FormLabel>
                              <FormControl>
                                <Textarea
            ...
            {isRoomBlock && (
              <div className="rounded-lg bg-destructive/5 border border-destructive/20 p-3 flex gap-3 text-destructive items-start">
                ...
                <div className="text-xs space-y-0.5">
                  ...
                  Giá phòng mặc định được đặt là 0đ cho việc giữ chỗ hoặc bảo
                  trì.
                </div>
              </div>
            )}
                        ...
                        <FormItem className="space-y-2">
                          ...
                          <FormControl>
                            <PaymentMethodSelector
                              ...
                              bookingSource={source || "DirectStaff"}
